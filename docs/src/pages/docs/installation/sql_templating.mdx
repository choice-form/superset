...
coworker in Spain the following SQL Lab URL `www.example.com/sqllab?countrycode=ES`
and your coworker in the USA the following SQL Lab URL `www.example.com/sqllab?countrycode=US`
