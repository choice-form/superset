 ...
 * under the License.
 */
import { t, ChartMetadata, ChartPlugin, Behavior, ChartProps, QueryFormData } from 'src/core';
...
export default class PivotTableChartPlugin extends ChartPlugin<PivotTableQueryFormData, ChartProps<QueryFormData>> {
  /**
