...
import { BoxPlotChartTransformedProps, BoxPlotQueryFormData, EchartsBoxPlotChartProps } from './types';
import { extractGroupbyLabel, getColtypesMapping, sanitizeHtml } from '../utils/series';
import { defaultGrid, defaultTooltip, defaultYAxis } from '../defaults';
import { getPadding } from '../Timeseries/transformers';

export default function transformProps(chartProps: EchartsBoxPlotChartProps): BoxPlotChartTransformedProps {
        ...
        return {
          ...
          tooltip: {
            formatter: (param: { data: [string, number] }) => {
              ...
              const headline = groupbyLabels.length ? `<p><strong>${sanitizeHtml(outlierName)}</strong></p>` : '';
