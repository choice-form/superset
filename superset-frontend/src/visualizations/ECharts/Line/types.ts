...
import { EchartsLineLabelType } from './constants';

export type EchartsLineFormData = EchartsLegendFormData & {
  colorScheme?: string;
  ...
  innerRadius: number;
  labelLine: boolean;
  labelType: EchartsLineLabelType;
...
export interface EchartsLineChartProps extends ChartProps {
  formData: EchartsLineFormData;
