  ...
  return buildQueryContext(formData, baseQueryObject => [
    {
      ...
      ...(drillDown && {
        groupby: [DrillDown.getColumn((ownState && ownState?.drilldown) || undefined, groupby as string[])],
        filters: [
          ...(baseQueryObject.filters || []),
          ...DrillDown.getFilters((ownState && ownState?.drilldown) || undefined, groupby as string[]),
        ],
      }),
    },
  ]);
