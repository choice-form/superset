...
const ListViewPagination = createUltimatePagination({
  ...
  itemTypeToComponent: {
    ...
    [ITEM_TYPES.ELLIPSIS]: ({ isActive, onClick }) => <Pagination.Ellipsis disabled={isActive} onClick={onClick} />,
    [ITEM_TYPES.PREVIOUS_PAGE_LINK]: ({ isActive, onClick }) => (
      <Pagination.Prev disabled={isActive} onClick={onClick} />
    ),
    [ITEM_TYPES.NEXT_PAGE_LINK]: ({ isActive, onClick }) => <Pagination.Next disabled={isActive} onClick={onClick} />,
