...
import { OptionProps, OptionItemInterface } from 'src/explore/components/controls/DndColumnSelectControl/types';
...
export default function OptionWrapper(
  ...
  const ColumnOption = () => (
    <StyledColumnOption column={column as ColumnMeta} labelRef={labelRef} showTooltip={!!shouldShowTooltip} showType />
  );
  ...
  return (
    <DragContainer ref={ref} {...rest}>
      <Option index={index} clickClose={clickClose} withCaret={withCaret} isExtra={isExtra} canDelete={canDelete}>
        <Label />
      </Option>
    </DragContainer>
  );
