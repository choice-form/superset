...
import { COMMON_RANGE_OPTIONS, COMMON_RANGE_SET } from 'src/explore/components/controls/DateFilterControl/utils';
import { CommonRangeType, FrameComponentProps } from 'src/explore/components/controls/DateFilterControl/types';
...
export function CommonFrame(props: FrameComponentProps) {
  ...
  return (
    <>
      ...
      <Radio.Group value={commonRange} onChange={(e: any) => props.onChange(e.target.value)}>
